const TermsofServicePage = async () => {
    ...
    return (
        <div className="h-full p-4 space-y-2">
            <h3 className="text-lg font-medium"><strong>Terms and Conditions</strong></h3>
            <div className="text-muted-foreground text-sm"><br></br>
                <p>Welcome to AI COMPANION!</p><br></br>
                <p>These terms and conditions outline the rules and regulations for the use of ParaSocial&apos;s
                    Website, located at https://www.aicompanion.me/.</p><br></br>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use AI
                    COMPANION if you do not agree to take all of the terms and conditions stated on this page.</p>
                <br></br>
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    Notice and all Agreements: &rdquo;Client&rdquo;, &rdquo;You&rdquo; and &rdquo;Your&rdquo; refers to
                    you, the person log on this website and compliant to the Company&apos;s terms and
                    conditions. &rdquo;The
                    Company&rdquo;, &rdquo;Ourselves&rdquo;, &rdquo;We&rdquo;, &rdquo;Our&rdquo; and &rdquo;Us&rdquo;,
                    refers to our Company. &rdquo;Party&rdquo;, &rdquo;Parties&rdquo;, or &rdquo;Us&rdquo;, refers to
                    both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment
                    ...
                    the above terminology or other words in the singular, plural, capitalization and/or he/she or they,
                    are taken as interchangeable and therefore as referring to same.</p><br></br>
                <h3 className="text-lg font-medium">Cookies</h3><br></br>
                <p>We employ the use of cookies. By accessing AI COMPANION, you agreed to use cookies in agreement with
                    the ParaSocial&apos;s Privacy Policy. </p><br></br>
                ...
                <br></br>
                <h3 className="text-lg font-medium">License</h3><br></br>
                <p>Unless otherwise stated, ParaSocial and/or its licensors own the intellectual property rights for all
                    material on AI COMPANION. All intellectual property rights are reserved. You may access this from AI
                    COMPANION for your own personal use subjected to restrictions set in these terms and conditions.</p>
                <br></br>
                <p>You must not:</p><br></br>
                <ul>
                    <li>Republish material from AI COMPANION</li>
                    <li>Sell, rent or sub-license material from AI COMPANION</li>
                    <li>Reproduce, duplicate or copy material from AI COMPANION</li>
                    <li>Redistribute content from AI COMPANION</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. ParaSocial does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of ParaSocial,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                    and opinions. To the extent permitted by applicable laws, ParaSocial shall not be liable for the
                    Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of
                    and/or posting of and/or appearance of the Comments on this website.</p><br></br>
                <p>ParaSocial reserves the right to monitor all Comments and to remove any Comments which can be
                    considered inappropriate, offensive or causes breach of these Terms and Conditions.</p><br></br>
                <p>You warrant and represent that:</p><br></br>
                <ul>
                ...
                <br></br>
                <p>You hereby grant ParaSocial a non-exclusive license to use, reproduce, edit and authorize others to
                    use, reproduce and edit any of your Comments in any and all forms, formats or media.</p><br></br>
                <h3 className="text-lg font-medium">Hyperlinking to our Content</h3><br></br>
                <p>The following organizations may link to our Website without prior written approval:</p><br></br>
                <ul>
                ...
                <p>These organizations may link to our home page, to publications or to other Website information so
                    ...
                    the context of the linking party&apos;s site.</p><br></br>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of ParaSocial; and (d) the link is in the context of general resource information.</p>
                <br></br>
                <p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive;
                    ...
                    products or services; and (c) fits within the context of the linking party&apos;s site.</p><br></br>
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to ParaSocial. Please include your name, your
                    ...
                    to link. Wait 2-3 weeks for a response.</p><br></br>
                <p>Approved organizations may hyperlink to our Website as follows:</p><br></br>
                <ul>
                ...
                <p>No use of ParaSocial&apos;s logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p><br></br>
                <h3 className="text-lg font-medium">iFrames</h3><br></br>
                <p>Without prior approval and written permission, you may not create frames around our Webpages that
                    alter in any way the visual presentation or appearance of our Website.</p><br></br>
                <h3 className="text-lg font-medium">Content Liability</h3><br></br>
                <p>We shall not be hold responsible for any content that appears on your Website. You agree to protect
                    ...
                    violates, or advocates the infringement or other violation of, any third party rights.</p><br></br>
                <h3 className="text-lg font-medium">Your Privacy</h3><br></br>
                <p>Please read Privacy Policy</p><br></br>
                <h3 className="text-lg font-medium">Reservation of Rights</h3><br></br>
                <p>We reserve the right to request that you remove all links or any particular link to our Website. You
                    ...
                    our Website, you agree to be bound to and follow these linking terms and conditions.</p><br></br>
                <h3 className="text-lg font-medium">Removal of links from our website</h3><br></br>
                <p>If you find any link on our Website that is offensive for any reason, you are free to contact and
                    ...
                    to respond to you directly.</p><br></br>
                <p>We do not ensure that the information on this website is correct, we do not warrant its completeness
                    ...
                    the website is kept up to date.</p><br></br>
                <h3 className="text-lg font-medium">Disclaimer</h3><br></br>
                ...
                <p>As long as the website and the information and services on the website are provided free of charge,
                    we will not be liable for any loss or damage of any nature.</p><br></br>
            </div>
            <br/>
            <br/>
