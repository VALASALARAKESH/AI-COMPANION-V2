    ...
    return (
        <div className="h-full p-4 space-y-2">
            ...
            {!isSubscribed && (
                <div>
                    <div className="py-2">
                        <span className="text-sky-500 mx-1 font-medium" >Pro plan</span> - <span className="text-sky-500 mx-1 font-medium">999 INR</span> / month.
                        
                        <div className="text-muted-foreground text-sm py-2 pb-2 pl-1">
                            * 50,000 tokens / month<br />
                        </div>
                    ...
                    <div className="mt-4 py-2">
                        ...
                        <span className="text-purple-500 mx-1 font-medium">Unlimited plan</span> - <span className="text-purple-500 mx-1 font-medium">1499 INR</span> / month.
                        <div className="text-muted-foreground text-sm py-2 pb-2 pl-1">
